...
$persona = $sentencia->fetch(PDO::FETCH_OBJ);
    ...
    $data = [
        ...
        "message" =>  'Estimado(a) *'.strtoupper($persona->nombres).' '.strtoupper($persona->apellido_paterno).' '.strtoupper($persona->apellido_materno).'* Su cupo a sido '.strtoupper("RECHAZADO").' lamentamos las molestias.'
    ];
    $options = array(
        'http' => array(
            'method'  => 'POST',
